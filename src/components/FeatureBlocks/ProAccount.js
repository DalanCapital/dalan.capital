      ...
      <Container>
        <div className="relative mx-auto w-full max-w-lg sm:max-w-xl lg:mx-0 lg:max-w-none">
          ...
          <div className="w-full border border-gray-secondary-400/60 bg-gray-secondary-50 px-6 py-10 sm:p-14 lg:ml-auto lg:w-7/12 lg:py-32 lg:pl-28 xl:pl-36 xl:pr-20">
            ...
            Trade Safer and Smarter 
            </h2>
            <p className="mt-6 leading-relaxed text-slate-700 sm:mt-8 sm:text-lg sm:leading-8">
            Pro Account focuses on efficient risk management and lower trading costs to provide traders with a dependable and profitable trading experience.
             Pro Account provides a complete trading solution that enables traders to meet their financial objectives with its low spread, 
             no commission, risk management system, weekly settlement feature, and algorithmic trading capacity. 
             Pro Account promises to offer traders a combination of simplicity, effectiveness, and profitability with these features, 
             enabling them to trade more precisely and consistently. 
            </p>
            <Button
              href="#"
              variant="ghost"
