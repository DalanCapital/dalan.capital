      ...
      <div class="grid grid-cols-2 gap-8 lg:grid-cols-6">
        <div class="col-span-2">
          <a
            ...
            <img src="/img/f-logo.png" class="w-28" alt=" Logo dalan.capital" />
          </a>

          <p class="font-light text-white mt-10">
            Dalan is a open-source library of over 400+ web components and
            ...
            <li>
              <a href="#">
                <svg
                  ...
                  height="20"
                  viewBox="0 0 20 20"
                  class="fill-gray-200 hover:fill-white">
                  <path
                    d="M7.52866 20L7.5 11.25H3.75V7.5H7.5V5C7.5 1.626 9.58939 0 12.5992 0C14.041 0 15.2801 0.107338 15.6412 0.155313V3.68134L13.5537 3.68229C11.9168 3.68229 11.5998 4.46012 11.5998 5.60155V7.5H16.25L15 11.25H11.5998V20H7.52866Z"></path>
                </svg>
              </a>
            </li>
            <li>
              <a href="#">
                <svg
                  ...
                  class="fill-gray-200 hover:fill-white">
                  <path
                    d="M19.75 6C19.5 4.375 18.75 3.25 17 3C14.25 2.5 10 2.5 10 2.5C10 2.5 5.75 2.5 3 3C1.25 3.25 0.375 4.375 0.25 6C0 7.625 0 10 0 10C0 10 0 12.375 0.25 14C0.5 15.625 1.25 16.75 3 17C5.75 17.5 10 17.5 10 17.5C10 17.5 14.25 17.5 17 17C18.75 16.625 19.5 15.625 19.75 14C20 12.375 20 10 20 10C20 10 20 7.625 19.75 6ZM7.5 13.75V6.25L13.75 10L7.5 13.75Z"></path>
                </svg>
              </a>
            </li>
            <li>
        ...
        <div class="lg:mx-auto">
          <h2 class="mb-6 text-md font-semibold text-white">Company</h2>
          <ul class="text-white">
        ...
        <div class="lg:mx-auto">
          <h2 class="mb-6 text-md font-semibold text-white">Solutions</h2>
          <ul class="text-white">
            <li
              v-for="(link, index) in solutionLinks"
              :key="index"
              class="mb-4">
              <NuxtLink :to="link.link">
                {{ link.title }}
        ...
        <div class="lg:mx-auto">
          <h2 class="mb-6 text-md font-semibold text-white">Integrations</h2>
          <ul class="text-white">
            <li
              v-for="(link, index) in integrationsLinks"
              :key="index"
              class="mb-4">
              <NuxtLink :to="link.link">
                {{ link.title }}
        ...
        <div class="lg:mx-auto">
          <h2 class="mb-6 text-md font-semibold text-white">Resources</h2>
          <ul class="text-white">
            <li
...
const solutionLinks = ref([
  { title: "For small creators", link: "/" },
  { title: "For professionals", link: "/" },
  { title: "For large companies", link: "/" },
  { title: "Webinars", link: "/" },
  { title: "Live shows", link: "/" },
  { title: "Virtual conferences", link: "/" },
]);
